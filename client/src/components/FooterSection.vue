...
<template>
  <footer class="body-font bg-cyan-600 text-white">
    <div
    ...
    >
      <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        ...
        >
          <Logo />
          <span class="ml-3 text-xl text-gray-200">Stingray.fit</span>
        </a>
        <ul class="list-none mt-4">
          <li>Stingray Performance LLC</li>
          <li>30 North Gould Street</li>
      ...
      >
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          <h2
            class="title-font font-medium text-gray-200 tracking-widest text-sm mb-3"
          >
            Company
          </h2>
          <nav class="list-none">
            <li>
              <router-link
                to="/policies/terms"
                class="text-white cursor-pointer hover:text-gray-800"
              >
                Terms of Service
              </router-link>
            </li>
            ...
            <li>
              <router-link
                to="/policies/security-capabilities"
                class="text-white cursor-pointer hover:text-gray-800"
              >
    ...
    <div class="bg-cyan-700">
      ...
      >
        <p class="text-sm text-white sm:py-2 sm:mt-0 mt-4">
          &copy; 2023 Firefly —
          <a
            href="https://www.instagram.com/m.muham3d/"
            class="ml-1"
            target="_blank"
            >@m.muham3d</a
          >
        ...
        >
          <a
            ...
            target="_blank"
          >
            <span class="mdi mdi-youtube text-4xl"></span>
          </a>
          <a
            class="ml-3"
            href="https://www.instagram.com/stingray.fit/"
            target="_blank"
          >
  ...
  <!-- <footer class="body-font bg-cyan-600">
        <div class="container px-5 py-4 mx-auto">
            <div class="flex justify-around sm:flex-row flex-col">
                ...
                <nav class="list-none">
                    <li>
                        <a class="text-white cursor-pointer hover:text-gray-800">
                            Terms of Service
                        </a>
                    </li>
                    <li>
                        <a class="text-white cursor-pointer hover:text-gray-800">Privacy Policy</a>
                    </li>
                    <li>
                        <a class="text-white cursor-pointer hover:text-gray-800">
                            Security Capabilities
