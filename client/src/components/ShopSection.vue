  ...
  <section class="price" id="shop">
    ...
    <div class="container-price">
      <div class="box-price">
        ...
        <ul>
          <li>
            &#10003; {{ t('product_line_1', {}, { locale: lang.value }) }}
          </li>
          <li>
            &#10003; {{ t('product_line_2', {}, { locale: lang.value }) }}
          </li>
          <li>
            &#10003; {{ t('product_line_3', {}, { locale: lang.value }) }}
          </li>
          <li>
            &#10003; {{ t('product_line_4', {}, { locale: lang.value }) }}
          </li>
          <li>
            &#10003; {{ t('product_line_5', {}, { locale: lang.value }) }}
          </li>
          <li>
            &#10003; {{ t('product_line_6', {}, { locale: lang.value }) }}
          </li>
          <li>
            &#10003; {{ t('product_line_7', {}, { locale: lang.value }) }}
          </li>
        </ul>
        <ButtonComponent
        ...
        <DialogComponent :show="open2" @close="open2 = false">
          ...
          <template v-slot:body>
            ...
            <p class="mb-3">
              ...
              thrust) onda ide zagrijavanje bez tega 1x12, pa onda sa tegom
              zadani broj serija. <br />
